    ...
    <section ref={sectionRef} className="py-12 md:py-16 bg-white">
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        <div
          ...
          style={{
            background:
              "linear-gradient(145deg, #0B1F3A 0%, #0F2847 60%, #132F52 100%)",
          }}
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="max-w-lg">
              <p className="text-[11px] uppercase tracking-[0.2em] font-semibold text-white/40 mb-4">
                Get Started
              </p>
              <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight leading-snug mb-4">
                Ready to lock in your
                <br className="hidden md:block" /> income stability?
              </h2>
              <p className="text-white/40 text-sm leading-relaxed">
                Join 12,000+ partners who don&apos;t worry about rain or road
                closures anymore.
              </p>
            </div>
