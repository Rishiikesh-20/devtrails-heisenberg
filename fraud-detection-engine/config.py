...
EARNINGS_SPIKE_THRESHOLD = 1.40    # 40% above prior 4-week avg
ACTIVITY_SPIKE_HIGH = 2.0          # Delivery spike ratio for +25 pts
ACTIVITY_SPIKE_MED = 1.5           # Delivery spike ratio for +12 pts
